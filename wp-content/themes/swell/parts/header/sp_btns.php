...
<div class="l-header__customBtn sp_">
	<?php if ( $SETTING['search_pos_sp'] === 'header' ) : ?>
		<div class="c-iconBtn" data-onclick="toggleSearch" role="button" aria-label="<?=esc_attr__( '検索ボタン', 'swell' )?>">
...
<div class="l-header__menuBtn sp_">
	<div class="c-iconBtn -menuBtn" data-onclick="toggleMenu" role="button" aria-label="<?=esc_attr__( 'メニューボタン', 'swell' )?>">
