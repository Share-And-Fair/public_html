...
<div class="c-shareBtns <?=esc_attr( $share_btns_class )?>">
	...
	<ul class="c-shareBtns__list">
		...
		<?php if ( ( ! $is_fix && 'in' === $urlcopy_pos ) || ( $is_fix && 'none' !== $urlcopy_pos ) ) : ?>
			...
			<li class="c-shareBtns__item -copy">
				<div class="c-urlcopy c-shareBtns__btn <?=esc_attr( $hov_class )?>" data-clipboard-text="<?=esc_url( $share_url )?>" title="<?=esc_attr__( 'URLをコピーする', 'swell' )?>">
	...
	<?php if ( ! $is_fix && 'out' === $urlcopy_pos ) : ?>
		...
		<div class="c-shareBtns__item -copy c-big-urlcopy">
			<div class="c-urlcopy c-shareBtns__btn <?=esc_attr( $hov_class )?>" data-clipboard-text="<?=esc_url( $share_url )?>" title="<?=esc_attr__( 'URLをコピーする', 'swell' )?>" role="button">
			<div class="c-urlcopy__content">
