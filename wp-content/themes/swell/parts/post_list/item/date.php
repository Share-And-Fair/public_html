...
<div class="p-postList__times c-postTimes u-thin">
	<?php if ( $show_date ) : ?>
		<time class="c-postTimes__posted icon-posted" datetime="<?=esc_attr( $date->format( 'Y-m-d' ) )?>"><?=esc_html( $date->format( $date_format ) )?></time>
	<?php endif; ?>
	<?php if ( $show_modified ) : ?>
		<time class="c-postTimes__modified icon-modified" datetime="<?=esc_attr( $modified->format( 'Y-m-d' ) )?>"><?=esc_html( $modified->format( $date_format ) )?></time>
	<?php endif; ?>
</div>
