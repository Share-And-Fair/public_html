...
function hook_admin_enqueue_scripts( $hook_suffix ) {
	...
	if ( is_customize_preview() ) {
		...
		$asset_file = include T_DIRE . '/build/js/menu/balloon/index.asset.php';
		wp_enqueue_script( 'swell_balloon_js', $build . '/js/menu/balloon/index.js', $asset_file['dependencies'], SWELL_VERSION, true );
	...
	if ( $use_media ) {
		...
		wp_localize_script( 'mediauploader', 'swellText', [
